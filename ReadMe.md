# Performing-NER-and-Sentiment-Analysis-Using-NLTK
Lab: Performing NER and sentiment analysis on product reviews using NLTK ;  integrating extracted features into a recommender.
